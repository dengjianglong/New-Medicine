...
<head>
    ...
    function addHero() {
        ...
        Cell_8.innerText=$("i").value;
        Cell_8.className="s9";
        var Cell_9=tableRow.insertCell(9);
        Cell_9.innerText=$("j").value;
        Cell_9.className="s10";


        var Cell_10=tableRow.insertCell(10);
        Cell_10.innerHTML="<a href='#' onclick='Del(this.parentNode,this.parentNode.parentNode.rowIndex)'>删除bai</a>";
        Cell_10className="s11";
        var Cell_11=tableRow.insertCell(11);
        Cell_11.innerHTML="<a href='#' onclick='edit(this.parentNode.parentNode.rowIndex)' class='edit'>修改</a>";
        Cell_11.className="s12";
    }
    ...
    function edit(rowIndex) {
        ...
        rowHtml.cells[8].innerHTML = "<input type='text' value='"+rowHtml.cells[8].innerText+"' name='c0'>";
        rowHtml.cells[9].innerHTML = "<input type='text' value='"+rowHtml.cells[9].innerText+"' name='c0'>";


        rowHtml.cells[10].innerHTML = "<a href='#' onclick='Del(this.parentNode,this.parentNode.parentNode.rowIndex)'>删除</a>";
        rowHtml.cells[11].innerHTML = "<a href='#' onclick='save(this.parentNode.parentNode.rowIndex)' class='edit'>保存</a>";
    ...
    function save(rowIndex){
        ...
        rowHtml.cells[10].innerHTML = "<a href='#' onclick='Del(this.parentNode,this.parentNode.parentNode.rowIndex)'>删除</a>";
        rowHtml.cells[11].innerHTML = "<a href='#' onclick='edit(this.parentNode.parentNode.rowIndex)' class='edit'>修改</a>";
...
<li><a href="${pageContext.request.contextPath}/dm/findAllDM.do">表1  t_dm</a></li>
        ...
        <form action="${pageContext.request.contextPath}/weight/saveWeight.do" methon="post">
        
        <span class="span1">ID</span>
        <input id="ph" type="text" name="tDynasty"/>
        <span class="span1">Nane</span>
        <input id="xm" type="text" name="tJin"/>
        <span class="span1">Attribute</span>
        <input id="ch" type="text" name="tDan"/>
        <span class="span1">Attribute</span>
        <input id="d" type="text" name="tJun"/>
        <span class="span1">Attribute</span>
        <input id="e" type="text" name="tLiang"/>
        <span class="span1">Attribute</span>
        <input id="f" type="text" name="tZhu"/>
        <span class="span1">Attribute</span>
        <input id="g" type="text" name="tQian"/>
        <span class="span1">Attribute</span>
        <input id="h" type="text" name="tFen"/>
        ...
        <table id="mytable" cellspacing="0px" border="3" bordercolor="red">
            ...
            <c:forEach items="${weight }" var="weight">
             <tr>
                <td class="s1">${weight.id }</td>
                <td class="s2">${weight.tDynasty }</td>
                <td class="s3">${weight.tJin }</td>
                <td class="s4">${weight.tDan }</td>
                <td class="s5">${weight.tJun }</td>
                <td class="s6">${weight.tLiang }</td>
                <td class="s7">${weight.tZhu }</td>
                <td class="s8">${weight.tQian }</td>
                <td class="s9">${weight.tFen }</td>
                <td class="s10"><a href="${pageContext.request.contextPath}/weight/deleteWeight.do?id=${weight.id}" onclick='Del(this.parentNode,this.parentNode.parentNode.rowIndex)'>删除</a></td>
                <td class="s11"><a href="#" onclick="edit(this.parentNode.parentNode.rowIndex)">修改</a></td>
            </tr>
            </c:forEach>
