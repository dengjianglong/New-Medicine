...
<head>
    ...
    function addHero() {
        ...
        Cell_6.innerHTML="<a href='#' onclick='Del(this.parentNode,this.parentNode.parentNode.rowIndex)'>删除bai</a>";
        Cell_6className="s7";
        var Cell_7=tableRow.insertCell(7);
        Cell_7.innerHTML="<a href='#' onclick='edit(this.parentNode.parentNode.rowIndex)' class='edit'>修改</a>";
        Cell_7.className="s8";
    }
    ...
    function edit(rowIndex) {
        ...
        rowHtml.cells[6].innerHTML = "<a href='#' onclick='Del(this.parentNode,this.parentNode.parentNode.rowIndex)'>删除</a>";
        rowHtml.cells[7].innerHTML = "<a href='#' onclick='save(this.parentNode.parentNode.rowIndex)' class='edit'>保存</a>";
    ...
    function save(rowIndex){
        ...
        rowHtml.cells[6].innerHTML = "<a href='#' onclick='Del(this.parentNode,this.parentNode.parentNode.rowIndex)'>删除</a>";
        rowHtml.cells[7].innerHTML = "<a href='#' onclick='edit(this.parentNode.parentNode.rowIndex)' class='edit'>修改</a>";
    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/medicine/saveMedicine.do" methon="post">
        <span class="span1">Nane</span>
        <input id="xm" type="text" name="mName"/>
        <span class="span1">Attribute</span>
        <input id="ch" type="text" name="mEffect"/>
        <span class="span1">Attribute</span>
        <input id="d" type="text" name="mSmell"/>
        <span class="span1">Attribute</span>
        <input id="e" type="text" name="mKind"/>
        <span class="span1">Attribute</span>
        ...
        <table id="mytable" cellspacing="0px" border="3" bordercolor="red">
            ...
            <c:forEach items="${medicine }" var="medicine">
             <tr>
                <td class="s1">${medicine.id }</td>
                <td class="s2">${medicine.mName }</td>
                <td class="s3">${medicine.mEffect }</td>
                <td class="s4">${medicine.mSmell }</td>
                <td class="s5">${medicine.mKind }</td>
                <td class="s6"><a href="${pageContext.request.contextPath}/medicine/deleteMedicine.do?id=${medicine.id}" onclick='Del(this.parentNode,this.parentNode.parentNode.rowIndex)'>删除</a></td>
                <td class="s7"><a href="#" onclick="edit(this.parentNode.parentNode.rowIndex)">修改</a></td>
            </tr>
            </c:forEach>
