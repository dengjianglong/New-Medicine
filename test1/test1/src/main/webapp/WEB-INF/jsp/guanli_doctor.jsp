...
<form action="${pageContext.request.contextPath}/doctor/saveDoctor.do" methon="post">
        <span class="span1">Nane</span>
        <input id="xm" type="text" name="dName"/>
        <span class="span1">Attribute</span>
        <input id="ch" type="text" name="dBrief"/>
        <span class="span1">Attribute</span>
        <input id="d" type="text" name="dPic"/>
        <span class="span1">Attribute</span>
        <input id="e" type="text" name="dplace"/>
        <span class="span1">Attribute</span>
        <input id="f" type="text" name="dbirth"/>
        ...
        <table id="mytable" cellspacing="0px" border="3" bordercolor="red">
            <tr>
             ...
             <tr>
                <td class="s1">${doctor.id }</td>
                <td class="s2">${doctor.dName }</td>
                <td class="s3">${doctor.dBrief }</td>
                <td class="s4">${doctor.dPic }</td>
                <td class="s5">${doctor.dplace }</td>
                <td class="s6">${doctor.dbirth }</td>
                <td class="s7"><a href="${pageContext.request.contextPath}/doctor/deleteDoctor.do?id=${doctor.id}">删除</a></td>
                <td class="s8"><a href="#" onclick="edit(this.parentNode.parentNode.rowIndex)">修改</a></td>
            </tr>
            </c:forEach>
