...
<head>
    ...
    function addHero() {
        ...
        Cell_4.innerHTML="<a href='#' onclick='Del(this.parentNode,this.parentNode.parentNode.rowIndex)'>删除bai</a>";
        Cell_4.className="s5";
        var Cell_5=tableRow.insertCell(5);
        Cell_5.innerHTML="<a href='#' onclick='edit(this.parentNode.parentNode.rowIndex)' class='edit'>修改</a>";
        Cell_5.className="s6";
    }
    ...
    function edit(rowIndex) {
        ...
        rowHtml.cells[4].innerHTML = "<a href='#' onclick='Del(this.parentNode,this.parentNode.parentNode.rowIndex)'>删除</a>";
        rowHtml.cells[5].innerHTML = "<a href='#' onclick='save(this.parentNode.parentNode.rowIndex)' class='edit'>保存</a>";
    ...
    function save(rowIndex){
        ...
        rowHtml.cells[4].innerHTML = "<a href='#' onclick='Del(this.parentNode,this.parentNode.parentNode.rowIndex)'>删除</a>";
        rowHtml.cells[5].innerHTML = "<a href='#' onclick='edit(this.parentNode.parentNode.rowIndex)' class='edit'>修改</a>";
...
<li><a href="${pageContext.request.contextPath}/dm/findAllDM.do">表1  t_dm</a></li>
        ...
        <form action="${pageContext.request.contextPath}/dm/saveDm.do" methon="post">
        <span class="span1">Name</span>
        <input id="xm" type="text" name="dmName"/>
        <span class="span1">Attribute</span>
        <input id="ch" type="text" name="dmPrescription"/>
...
<div class="text" style="text-align: center;">
        ...
        <table id="mytable" cellspacing="0px" border="3" bordercolor="red">
            ...
            <c:forEach items="${dm }" var="dm">
             <tr>
                <td class="s1">${dm.id }</td>
                <td class="s2">${dm.dmName }</td>
                <td class="s3">${dm.dmPrescription }</td>
                <td class="s5"><a href="${pageContext.request.contextPath}/dm/deleteDm.do?id=${dm.id}">删除</a></td>
                <td class="s6"><a href="#">修改</a></td>
            </tr>
            </c:forEach>
